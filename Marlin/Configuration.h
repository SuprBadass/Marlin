...
#define STRING_CONFIG_H_AUTHOR "(rllabs, Ender-3 SKR 1.4 Turbo)" // Who made the changes.
...
// RAL: (TODO): Might be okay with (50*60), (50*60), (4*60)
...
//
// SuprBadass: Ender 3 Pro default hotend and bed
